...
function SnakeInit() {
    ...
    this.currentDiret = "";  //Current Direction
    this.bindStartEvent();   //Event
    this.score = 0;
}
SnakeInit.prototype.cashDectet = function () {
    /*
        1. Hit the wall;
        2. Hit itself, check whether the coordinates of the head are the same as the coordinates of the bodyPosition;
    */
...
SnakeInit.prototype.addBody = function (x,y) {
    //  delete apple + add appple + change snake size
    var apple = document.getElementsByClassName('apple');
    var n = apple.length,
